...
func (c *Clipboard) GetReadTextFunction() *v8go.FunctionTemplate {
...
func (c *Clipboard) GetWriteTextFunction() *v8go.FunctionTemplate {
	return v8go.NewFunctionTemplate(c.VM, func(info *v8go.FunctionCallbackInfo) *v8go.Value {
		args := info.Args()
...
func (c *Clipboard) GetV8Object() (*v8go.ObjectTemplate, error) {
	clipboardObj := v8go.NewObjectTemplate(c.VM)
	readFn := c.GetReadTextFunction()
	clipboardObj.Set("readText", readFn, v8go.ReadOnly)

	writeFn := c.GetWriteTextFunction()
